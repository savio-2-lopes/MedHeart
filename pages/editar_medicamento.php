...
if (isset($_POST['submit'])) {
	...
	$id = $_GET['id'];
	$query = mysqli_query($conexao, "UPDATE cad_medicamento set nome_medicamento='$nome_medicamento',  categoria='$categoria', efeito='$efeito', quantidade='$quantidade', preco='$preco', data_validade='$data_validade' where id='$id'");

	if ($query) {
		echo "<script language='javascript'>window.alert('Medicamento editado com sucesso!'); </script>";
		echo "<script>window.location.href='ver_medicamentos.php'</script>";
	} else {
		echo "<script language='javascript'>window.alert('Ocorreu um erro ao editar o Medicamento!');</script>";
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<span id="" style="color:#666;"><strong>Editar Medicamento</strong></span>
							</div><br>
							...
							<div class="form-group">
								...
								<div class="col-lg-6"><br><br>
									<input type="submit" class="btn btn-primary" name="submit" value="Editar Medicamento"></button>
								</div>
							</div>
						</div><br><br><br><br>
					</div>
