<?php
	...
	$rs  = $obj->showRecLab();				// Importando Objeto
	$rs1 = $obj->showMedico();				// Importando Objeto
		
	if(isset($_GET['del']))
	{	   
		$obj->deletar_requisicao_lab(intval($_GET['del']));
	}
?> 
						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<span id="" style="color:#666666;"><strong>Histórico de Requisições de Laboratório</strong></span>
								</div><br>
										...
										<table class="table table-striped table-bordered table-hover" id="dataTables-example">
											<thead>
												<tr>
													...
													<th><span id="" style="color:#666666;"><strong>Laboratório</strong></th>
											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<td>
														<span id="" style="color:#666666;"><?php echo htmlentities(strtolower($res->lab));?></span>
													</td>
